...
#include "CustomGameDataEntity.generated.h"

USTRUCT()
struct FCustomGameDataEntity
{
	...
	FCustomGameDataEntity()
	{
		...
		DeviceSerial = "";
		Version = 1;
		EntityName = "CustomGameDataEntity";
	}
	...
	{
		return "[{\"GameId\": 1,\"CustomGameData\": 1,\"MethodType\": 1,\"Catalog\":\"catalog\",\"UserId\": 1,\"DeviceSerial\":\"deviceserial\",\"Version\": 1,\"EntityName\":\"entityname\"}]";
	}

	static void Check()
	{
		TArray<FCustomGameDataEntity> data;
		FJsonObjectConverter::JsonArrayStringToUStruct(FCustomGameDataEntity::GetJsonExample(), &data, 0, 0);
