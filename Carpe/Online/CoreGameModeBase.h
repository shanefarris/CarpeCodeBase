...
UCLASS(config=Game)
class CARPE_API ACoreGameModeBase : public AGameMode
{
...
public:
	...
	UPROPERTY()
	TArray<AInventoryItem*> LevelInventoryItems;

	/** The bot pawn class */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="CFG|GameMode")
	...
	virtual bool CanDealDamage(AGamePlayerState* DamageInstigator, AGamePlayerState* DamagedPlayer) const;
	...
	/** Create a bot */
	AAIController* CreateBot(int32 BotNum);	
...
protected:
	...
	UPROPERTY()
	TArray<AAIController*> BotControllers;
	...
	virtual void InitBot(AAIController* AIC, int32 BotNum);

	/** check who won */
	virtual void DetermineMatchWinner();

	/** check if PlayerState is a winner */
	virtual bool IsWinner(AGamePlayerState* PlayerState) const;
