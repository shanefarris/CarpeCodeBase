...
UCLASS(config=Game)
class CARPE_API ASession : public AGameSession
{
...
protected:
	...
	FSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FGameOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FGameOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(ASession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(ASession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(ASession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(ASession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
