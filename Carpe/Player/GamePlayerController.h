...
public:
	...
	UFUNCTION(BlueprintCallable, Category="CFG|Input")
...
// 	virtual void Emote(const FString& Msg);
	...
	void OnDeathMessage(class AGamePlayerState* KillerPlayerState, class AGamePlayerState* KilledPlayerState, const UDamageType* KillerDamageType);
	...
	// begin AGamePlayerController-specific
	...
	// end AGamePlayerController-specific
