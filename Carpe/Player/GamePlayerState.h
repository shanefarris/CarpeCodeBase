...
UCLASS()
class CARPE_API AGamePlayerState : public APlayerState
{
...
public:
	...
	void ScoreKill(APlayerState* Victim, int32 Points);

	/** player died */
	void ScoreDeath(APlayerState* KilledBy, int32 Points);
	...
	void InformAboutKill(class AGamePlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AGamePlayerState* KilledPlayerState);

	/** broadcast death to local clients */
	UFUNCTION(Reliable, NetMulticast)
	void BroadcastDeath(class AGamePlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AGamePlayerState* KilledPlayerState);
